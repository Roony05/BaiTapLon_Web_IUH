...
!(function (t, e) {
  ...
  class Lt extends W {
    ...
    _maybeEnableCycle() {
      this._config.ride &&
        (this._isSliding ? N.one(this._element, pt, () => this.cycle()) : this.cycle());
    }
    to(t) {
  ...
  function be(t) {
    return (
      "undefined" != typeof ShadowRoot && (t instanceof me(t).ShadowRoot || t instanceof ShadowRoot)
    );
  }
  const ve = {
    name: "applyStyles",
      ...
      : ei(
          (function (t) {
            var e,
              ...
              l = -n.scrollTop;
            return (
              "rtl" === Le(s || i).direction && (a += we(i.clientWidth, s ? s.clientWidth : 0) - o),
        ...
        (("body" !== pe(e) || Je(a)) &&
          (c =
            (n = e) !== me(n) && _e(n)
              ...
              : Ue(n)),
        _e(e) ? (((h = Oe(e, !0)).x += e.clientLeft), (h.y += e.clientTop)) : a && (h.x = Ge(a))),
      {
  ...
  class Ji extends H {
    ...
    dispose() {
      this._isAppended &&
        (N.off(this._element, Yi), this._element.remove(), (this._isAppended = !1));
    }
    _getElement() {
      if (!this._element) {
  ...
  class us extends W {
    ...
    hide() {
      if (
        ...
        if (
          (this._getTipElement().classList.remove(ns), "ontouchstart" in document.documentElement)
        )
          for (const t of [].concat(...document.body.children)) N.off(t, "mouseover", h);
        ...
        if ("click" === e)
          ...
          N.on(this._element, t, this._config.selector, (t) => {
            ...
            N.on(this._element, i, this._config.selector, (t) => {
              const e = this._initializeOnDelegatedTarget(t);
              (e._activeTrigger["focusout" === t.type ? ls : as] = e._element.contains(
                t.relatedTarget
              )),
                e._leave();
            });
